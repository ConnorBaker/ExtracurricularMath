...
\begin{frame}{Definition}
  ...
  \begin{example}[Different Whole Number Bases]
    $125_{10}$ \pause
...
\begin{frame}{Definition}
  ...
  \begin{example}[Radix Point Expressions]
      $10.5_{10}$
...
\begin{frame}{Definition}
  ...
  \begin{example}[Example of Beta Expansions]
...
\begin{frame}{Definition}
  ...
  \begin{example}[Examples of Words]
    Cat (English)\pause
...
\begin{frame}{Definition}
  ...
  \begin{example}[Examples of Languages]
    English \pause
