...
\begin{frame}{Dealing with Radix Point Expressions (Arithmetically)}
  \begin{example}[Convert $(\varphi/2)_{10}$ to base golden ratio.]\pause
    \begin{enumerate}
...
\begin{frame}{Escaping the Beta Map}
  \begin{example}[Golden Base Ratio: $T(0.01101_\varphi)$]
...
\begin{frame}{Language Generated by Base $\frac{5+(3\sqrt{5})}{2}$}
  \begin{itemize}
    \item Positive solution of the monic polynomial $x^2=5x+5$ \pause
    \item Base is $\approx 5.85$, so it's equivalent to base 5 \pause
    \item $0.\overline{54}_\beta$ is the orbit of one \pause
    \item Therefore, 55 is the forbidden word in the language
  \end{itemize}
\end{frame}

\begin{frame}{FSM For Language Generated by Base $\frac{5+(3\sqrt{5})}{2}$}
  \begin{center}
    \begin{tikzpicture}[scale=0.2]
      \tikzstyle{every node}+=[inner sep=0pt]
      \draw [black] (33.9,-29.4) circle (3);
      \draw [black] (50.2,-29.4) circle (3);
      \draw [black] (31.22,-30.723) arc (-36:-324:2.25);
      \draw (26.65,-29.4) node [left] {$0,1,2,3,4$};
      \fill [black] (31.22,-28.08) -- (30.87,-27.2) -- (30.28,-28.01);
      \draw [black] (48.1,-31.527) arc (-53.15335:-126.84665:10.089);
      \fill [black] (48.1,-31.53) -- (47.16,-31.61) -- (47.76,-32.41);
      \draw (42.05,-34.04) node [below] {$5$};
      \draw [black] (35.982,-27.255) arc (127.27809:52.72191:10.019);
      \fill [black] (35.98,-27.26) -- (36.92,-27.17) -- (36.32,-26.37);
      \draw (42.05,-24.71) node [above] {$0,1,2,3,4$};
    \end{tikzpicture}
  \end{center}
\end{frame}
